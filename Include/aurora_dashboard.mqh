...
void CAuroraDashboard::Update(const SAuroraState &state) {
   ...
   int stats_block_h = stats_line_gap * 3 + Scale(10); // 3 gaps + last text height approx
...
void CAuroraDashboard::DrawStats(int &y) {
   ...
   // Let's advance responsibly
   y += (gap * 3) + Scale(15); // + some bottom stats padding
